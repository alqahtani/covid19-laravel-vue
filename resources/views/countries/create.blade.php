<x-layouts.app>
  <div class="p-10 sm:h-full sm:flex sm:flex-col sm:justify-center sm:px-0 sm:w-11/12 sm:mx-auto">
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="todayDeaths" class="block text-sm font-medium leading-5 text-gray-700">Today Deaths:
                      <span
                        class="text-xs text-indigo-600 bg-indigo-100 px-1 border-indigo-400 border rounded inline-block">{{ now()->format('l, d F Y') }}</span></label>
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="critical" class="block text-sm font-medium leading-5 text-gray-700">Critical
                      Cases</label>
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="totalTests" class="block text-sm font-medium leading-5 text-gray-700">Total
                      Tests</label>
